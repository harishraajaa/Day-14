...
var div = create('div', 'container mt-6 ml-6 mr-6 mb-6 p-1');
...
h1.setAttribute("class","text-md-center")
...
div.append(divarr[0], divarr[1], divarr[2], divarr[3], divarr[4], divarr[5]);
